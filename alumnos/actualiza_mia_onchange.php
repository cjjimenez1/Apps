...
Tiene un combo que se rellana con los nombres de los alumnos de la tabla y al seleccionar o cambiar una opción del desplegable
muestra un formulario con los datos del alumno seleccionado. Esto lo hace con la función "onchange" en el Select que rellena el combo con los Id de los alumnos.
En ese formulario podemos editar todos los datos del alumnos excepto el "Id" y al pulsar el botón "Actualizar" se actualizan los nuevos datos en 
...
<html>
    ...
    <body>
        ...
        echo "<option value=0>Seleccione un alumno</option>";//Pongo el combo a 0 para que al cambiar a un id me muestre ese alumno
